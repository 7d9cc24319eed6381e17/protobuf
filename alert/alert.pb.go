...
var file_alert_proto_rawDesc = []byte{
	...
	,
}
...
var file_alert_proto_goTypes = []interface{}{
	(*Stock)(nil),       // 0: alert.Stock
	(*empty.Empty)(nil), // 1: google.protobuf.Empty
}
var file_alert_proto_depIdxs = []int32{
	0, // 0: alert.Alert.newStockData:input_type -> alert.Stock
	1, // 1: alert.Alert.newStockData:output_type -> google.protobuf.Empty
...
type AlertClient interface {
	NewStockData(ctx context.Context, in *Stock, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *alertClient) NewStockData(ctx context.Context, in *Stock, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/alert.Alert/newStockData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AlertServer interface {
	NewStockData(context.Context, *Stock) (*empty.Empty, error)
}
...
func (*UnimplementedAlertServer) NewStockData(context.Context, *Stock) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NewStockData not implemented")
}
...
func _Alert_NewStockData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Stock)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AlertServer).NewStockData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/alert.Alert/NewStockData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AlertServer).NewStockData(ctx, req.(*Stock))
	}
...
var _Alert_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "newStockData",
			Handler:    _Alert_NewStockData_Handler,
		},
	},
